...
def run(cyto_job, parameters):
    ...
    job.update(status=Job.RUNNING, progress=10, statusComment="Starting...")
...
#         download_size = parameters.download_size
        ...
        job.update(status=Job.RUNNING, progress=30, statusComment="Fetching annotations...")
...
#         job.update(progress=progress, statusComment="Analyzing annotation {}...".format(annotation.id))        
        job.update(status=Job.RUNNING, progress=50, statusComment="Writing annotations...")
        ...
        job.update(status=Job.RUNNING, progress=80, statusComment="Completing...")
